...
variable "poc-private-subnets" {
  type = list
  default = ["10.252.3.0/24" , "10.252.4.0/24", "10.252.5.0/24", "10.252.6.0/24", "10.252.7.0/24" , "10.252.8.0/24", "10.252.9.0/24", "10.252.10.0/24", "10.252.11.0/24", "10.252.12.0/24"]
}
